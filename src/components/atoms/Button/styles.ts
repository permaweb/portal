...
export const IconPrimary = styled.div<{
	...
	svg {
		...
		width: 15.5px;
		padding: 1.5px 0 0 0;
		margin: ${(props) => (props.leftAlign ? '3.25px 7.5px 0 0' : '2.25px 0 0 10.5px')};
		color: ${(props) =>
			props.warning
				? props.theme.colors.font.light1
				: props.disabled
...
export const Alt2 = styled(Alt1)`
	...
	&:focus {
		span {
			color: ${(props) =>
				props.warning ? props.theme.colors.font.light1 : props.theme.colors.button.alt2.active.color} !important;
		}
