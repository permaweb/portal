...
export const ICONS = {
	...
	layoutJournal: getTxEndpoint('BmBTIBRpkibfBDbzfLYNV0Roauhg7lM_soWjnMk8jx0'),
	layoutBlog: getTxEndpoint('AODUnGvDngaxkczzc4jJFXKV1fySUN1gjWJaHQJ5VT0'),
	layoutDocumentation: getTxEndpoint('0CQfnG1ej5uI0Zx4xmjT64NU4HILXJcrlJw5Hw4E4nA'),
	pageHomeJournal: getTxEndpoint('IrG5x1RZ0xqHcRKEw3UnayMefXyTtvbqkqU3KQE-G88'),
	pageHomeBlog: getTxEndpoint('bOHnbb-J4UKbjose3HpHMVO9ZWE4bUo9i2q42zRunVg'),
	pageHomeDocumentation: getTxEndpoint('-tDdhTtv_gEGWWjxL__hKP0qDOTXpLe5RZ3QOZohxV8'),
	...
	save: getTxEndpoint('S7EHh2ekWVFOJ_4V4upi-aqIpJvSXZpn_rIM0oTRz20'),
