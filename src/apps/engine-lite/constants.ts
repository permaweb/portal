export const ENGINE_LITE_THEME_STORAGE_KEY = 'portal-engine-lite-theme';
export const ENGINE_LITE_THEME_COLORS_STORAGE_PREFIX = 'portal-engine-lite-colors:';
export const ENGINE_LITE_BRAND_STORAGE_PREFIX = 'portal-engine-lite-brand:';

export const ENGINE_LITE_FALLBACK_LOGO = `<svg viewBox="0 0 256 256" aria-hidden="true">
