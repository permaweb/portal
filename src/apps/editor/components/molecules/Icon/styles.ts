...
export const LInput = styled.button<{ hasIcon: boolean }>`
	height: 100px;
	width: 100px;
	position: relative;
	background: ${(props) => props.theme.colors.container.primary.background};
	border: ${(props) => (props.hasIcon ? `none` : `1px dashed ${props.theme.colors.border.primary}`)};
