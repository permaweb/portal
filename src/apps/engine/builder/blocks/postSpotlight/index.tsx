      ...
      >
        ...
        <S.Data>
          ...
          <S.Meta>
            ...
            <span>· {isLoadingPost ? <Placeholder width="90" /> : new Date(Number(post?.dateCreated)).toLocaleString('en-US', { day: '2-digit', month: '2-digit', year: '2-digit', hour: '2-digit', minute: '2-digit', hour12: false })}</span>
          </S.Meta>
        </S.Data>
      </NavLink>
    </S.Wrapper>
