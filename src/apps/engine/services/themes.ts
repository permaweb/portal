...
export function initThemes(Themes: any[]) {  
  ...
  function getColor(theme: any, scheme: string, value: string) {
    switch(value) {
      case 'primary': return theme.basics.colors.primary[scheme];
      case 'secondary': return theme.basics.colors.secondary[scheme];
      case 'background': return theme.basics.colors.background[scheme];
      case 'text': return theme.basics.colors.text[scheme];
      case 'border': return theme.basics.colors.border[scheme];
  ...
  function setScheme(theme: any, scheme: string){
    ...
    updateThemeStyles(scheme, {
      ...
      // Buttons
      '--color-button-default': `rgba(${getColor(theme, scheme, theme.buttons.default.default.colors.color[scheme])},1)`,
      '--color-button-default-background': `rgba(${getColor(theme, scheme, theme.buttons.default.default.colors.background[scheme])},${theme.buttons.default.default.preferences.opacity[scheme]})`,
      '--color-button-default-border': `rgba(${getColor(theme, scheme, theme.buttons.default.default.colors.border[scheme])},1)`,
      '--color-button-default-hover': `rgba(${getColor(theme, scheme, theme.buttons.default.hover.colors.color[scheme])},1)`,
      '--color-button-default-hover-background': `rgba(${getColor(theme, scheme, theme.buttons.default.hover.colors.background[scheme])},${theme.buttons.default.hover.preferences.opacity[scheme]})`,
      '--color-button-default-hover-border': `rgba(${getColor(theme, scheme, theme.buttons.default.hover.colors.border[scheme])},1)`,

      '--color-button-primary': `rgba(${getColor(theme, scheme, theme.buttons.primary.default.colors.color[scheme])},1)`,
      '--color-button-primary-background': `rgba(${getColor(theme, scheme, theme.buttons.primary.default.colors.background[scheme])},${theme.buttons.primary.default.preferences.opacity})`,
      '--color-button-primary-border': `rgba(${getColor(theme, scheme, theme.buttons.primary.default.colors.border[scheme])},1)`,
      '--color-button-primary-hover': `rgba(${getColor(theme, scheme, theme.buttons.primary.hover.colors.color[scheme])},1)`,
      '--color-button-primary-hover-background': `rgba(${getColor(theme, scheme, theme.buttons.primary.hover.colors.background[scheme])},${theme.buttons.primary.hover.preferences.opacity})`,
      '--color-button-primary-hover-border': `rgba(${getColor(theme, scheme, theme.buttons.primary.hover.colors.border[scheme])},1)`,
